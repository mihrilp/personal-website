...
const SvgVisualStudioCode = (props: SVGProps<SVGSVGElement>) => (
  <svg
    viewBox="0 0 100 100"
    fill="none"
  ...
  >
    ...
    <g mask="url(#visual-studio-code_svg__a)">
      <path
        ...
        fill="#0065A9"
      />
      <g filter="url(#visual-studio-code_svg__b)">
        <path
      ...
      <g filter="url(#visual-studio-code_svg__c)">
        <path
      ...
      <path
        ...
        fill="url(#visual-studio-code_svg__d)"
        style={{
